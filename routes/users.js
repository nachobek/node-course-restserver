...
const { roleValidation, emailValidation } = require('../helpers/dbValidation');
...
router.post('/', [
    ...
    check('email', 'Email already exists').custom(emailValidation),
    ...
    check('role', 'Invalid role').custom(roleValidation),
    paramsValidation
], usersPost);
